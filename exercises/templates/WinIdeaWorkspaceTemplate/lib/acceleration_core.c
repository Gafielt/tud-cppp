...
/**
* @brief Config the start condition for I2C communication
* @param Addr The Slave address
* @return I2C_RET_ERROR  The start condition not generated or Slave address wasn't appended by ACK                            
* @return  I2C_RET_OK     The start condition generated, and the Slave address match and ACK generated
*/
static uint8_t I2c_Start(uint8_t Addr);

/**
* @brief Config the repeated start condition
* @param Addr The Slave address
* @return I2C_RET_ERROR The repeated start condition not generated or Slave address wasn't appended by ACK                           
* @return I2C_RET_OK The repeated start condition generated, and the Slave address match and ACK generated
*/
