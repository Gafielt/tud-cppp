...
\hints{
	...
	\item Um einen Delay auf dem µController ausführen, kannst du die Methode \lstinline|microDelay(uint32_t timeInMicroseconds)| verwenden. Zum Beispiel wird beim Aufruf  \lstinline|microDelay(20)| der µController 20µs pausiert.
}
