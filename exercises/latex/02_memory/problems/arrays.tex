...
Nutze dazu die Funktion \lstinline{std::stoi} aus dem Header \lstinline{string}\footnote{\url{http://www.cplusplus.com/reference/string/stoi/}} (benötigt C++11), um \lstinline{argv[1]} in eine Ganzzahl zu konvertieren.
