...
\hints{
	\item Über \lstinline{std::make_shared(<Konstruktorparameter>)} kann man auch einen Smart Pointer erhalten. Allerdings funktioniert dies in dieser Aufgabe nicht, da dazu der Konstruktor aufgerufen wird, welcher hier als private deklariert ist.
