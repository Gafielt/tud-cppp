...
Bascially, just follow these instructions: http://codelite.org/LiteEditor/UnitTestPP .

Remarks:
  * You install cmake as follows: sudo apt install cmake
  * This project was created using the Codelite wizard for UnitTest++
...
# Short reference for UnitTest++
 ...
 If you want to re-use a set of test data for more than one test, or provide setupteardown for tests, 
